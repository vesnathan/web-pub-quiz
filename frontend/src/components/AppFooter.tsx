...
interface AppFooterProps {
  ...
  /** Optional: show game-specific info (score, question progress) */
  showGameInfo?: boolean;
  /** Player's current score (only shown when showGameInfo=true) */
  playerScore?: number;
  /** Questions remaining today for free users (undefined = unlimited) */
