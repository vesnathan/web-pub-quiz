...
export default function Home() {
  ...
  // Handle OAuth error callback - detect errors from URL params
  useEffect(() => {
    ...
    // Detect NATIVE_ACCOUNT_EXISTS from URL (email already has password account)
    if (errorDescription?.includes("NATIVE_ACCOUNT_EXISTS")) {
      window.history.replaceState({}, "", window.location.pathname);
      setNativeAccountMessage(true);
      setAuthMode("login");
      setShowAuthModal(true);
                        ...
                        {GOOGLE_OAUTH_ENABLED && (
                          <>
                            <Button
                              ...
                              isDisabled={googleSignInLoading}
                              startContent={
                                !googleSignInLoading ? (
